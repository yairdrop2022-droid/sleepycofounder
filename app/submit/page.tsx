    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-24 text-center">
        ...
        <p className="text-sm mb-8" style={{ color: "#7070a0" }}>
          Your MCP is under review. We'll publish it within 24 hours if it meets our guidelines.
        </p>
        <button
          onClick={() => {
            setState("idle");
            setFormData({ name: "", description: "", github_url: "", mcp_config_json: "", category: "", author_name: "", author_twitter: "", is_polsia_compatible: false });
            setSelectedTags([]);
          }}
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="text-center mb-12">
        <div
          ...
          style={{ background: "linear-gradient(135deg, #a855f7 0%, #3b82f6 100%)", boxShadow: "0 0 24px rgba(168,85,247,0.4)" }}
        >
      ...
      {state === "error" && (
        ...
        >
          ...
          <p className="text-sm" style={{ color: "#f87171" }}>
            Something went wrong. Please check your JSON and try again.
          </p>
        </div>
      )}
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: "#5050a0" }}>
                  I've tested this MCP with Polsia or similar agentic loop systems
                </p>
              </div>
            </label>
          </div>
